...
<?php }	
/*Now unlike in the guestbook skip the whole error checking because this is going to be a matter of convenience not accuracy for the business to compile notes in a database about the interview candidates (at least that is the assumption of mine)
...
/*
	$Department = validateInput($_POST['Field1'],"Department Name");        //input validation function call
	$Email = validateEmail($_POST['Field2'],"Title");		//email function validation
	$Subject = validateInput($_POST['Field3'],"Candidate's Name");        //input validation function call
	$Question1 = validateInput($_POST['Field4'],"Skills and Knowledge");        //input validation function call
	$Question2 = validateInput($_POST['Field5'],"Communication ability");        //input validation function call
	$Comments = validateInput($_POST['Field6'],"Comments");        //input validation function call
	$Date = validateInput($_POST['Field7'],"Date");        //input validation function call
	$Interviewer = validateInput($_POST['Field8'],"Reviewed by");        //input validation function call
	if($errorCount==0)
		$ShowForm=FALSE;
	else
		$ShowForm=TRUE;
