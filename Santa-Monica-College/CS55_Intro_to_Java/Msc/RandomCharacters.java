...
public class RandomCharacters 
{
    ...
    /**
	Class for random character includes many overloaded methods on it see bottom code
 */
    public static void main(String[] args) 
    {
       // RandomCharacter r = new RandomCharacter();
       // System.out.println(r.getRandomUpperCase());
        
        for(int i = 0 ; i < 120; i++)
        {
            System.out.print(RandomCharacter.getRandomChar('f', 'r'));
            if((i+1)%50==0)
                System.out.println();
