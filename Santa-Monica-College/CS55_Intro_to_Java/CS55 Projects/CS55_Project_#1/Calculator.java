...
/* NOTES REGARDING INSTRUCTIONS about Program Function and Structure:
   ...
   +The program lacks color for input/output and appearance could be improved (for later)
*/
...
public class Calculator {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Please enter two numbers separated by a space and then press Enter:");
