...
public class ShowGUIO 
{
    ...
    {   
        ...
        display("test",Color.ORANGE,Color.BLACK,3);
        System.exit(0);
    }        
    ...
    public static void display(String str,Color fg, Color bg, int mstype)
    {
        JTextArea jt = new JTextArea(20,25);
        jt.setBackground(bg);
        jt.setForeground(fg);
        ...
        jt.setFont(f);
        jt.setText(str);
        JOptionPane.showMessageDialog(null,jt,str,mstype);
    }        
}
